...
HD_PWD='D:/Projects/Ultrasonic/Ultrasonic.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log HC_SR04.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source HC_SR04.tcl

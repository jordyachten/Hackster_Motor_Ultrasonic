...
proc create_root_design { parentCell } {
  ...
  set TTC0_WAVE0_OUT_0 [ create_bd_port -dir O TTC0_WAVE0_OUT_0 ]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Ultrasonic_IP_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net Ultrasonic_IP_0_trigger [get_bd_ports trigger_0] [get_bd_pins Ultrasonic_IP_0/trigger]
  connect_bd_net -net echo_0_1 [get_bd_ports echo_0] [get_bd_pins Ultrasonic_IP_0/echo]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins Ultrasonic_IP_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins Ultrasonic_IP_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK1]
  ...
  connect_bd_net -net processing_system7_0_TTC0_WAVE0_OUT [get_bd_ports TTC0_WAVE0_OUT_0] [get_bd_pins processing_system7_0/TTC0_WAVE0_OUT]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins Ultrasonic_IP_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs Ultrasonic_IP_0/S00_AXI/S00_AXI_reg] -force

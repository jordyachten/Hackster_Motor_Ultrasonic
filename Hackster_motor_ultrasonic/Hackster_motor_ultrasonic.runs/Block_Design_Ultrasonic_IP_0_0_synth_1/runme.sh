...
HD_PWD='D:/Projects/Hackster_motor_ultrasonic/Hackster_motor_ultrasonic.runs/Block_Design_Ultrasonic_IP_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Block_Design_Ultrasonic_IP_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Block_Design_Ultrasonic_IP_0_0.tcl
